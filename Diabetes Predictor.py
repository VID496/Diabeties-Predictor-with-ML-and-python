...
df=pd.read_csv('/diabetes-dataset.csv')#enter Your Dataset
...
def sub():
    ...
    if y_pred==0:
        return print('No he/she is not suffering from diabetes')
    if y_pred==1:
        return print('Yes he/she is suffering from diabetes')
